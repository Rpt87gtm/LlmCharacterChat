...
namespace llmChat.Migrations
{
    ...
    [Migration("20241228044357_chats")]
    partial class chats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "aaac760a-94dd-44ff-a342-f62bc32d3d05",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "d043148d-1054-4bde-b90e-ed57f2c84c53",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("llmChat.Models.Chat.Character", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("Name", "CreatedByAppUserId")
                        .IsUnique();

                    b.ToTable("Characters");
                });

            modelBuilder.Entity("llmChat.Models.Chat.ChatHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("llmChat.Models.Chat.Character", b =>
                {
                    ...
                    b.HasOne("api.Models.User.AppUser", "CreatedByAppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("llmChat.Models.Chat.ChatHistory", b =>
                {
                    ...
                    b.HasOne("llmChat.Models.Chat.Character", "Character")
                        .WithMany()
            ...
            modelBuilder.Entity("llmChat.Models.Chat.Message", b =>
                {
                    b.HasOne("llmChat.Models.Chat.ChatHistory", null)
                        .WithMany("Messages")
